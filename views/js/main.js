...
var resizePizzas = function (size) {
    ...
    // query .randomPizzaContainer outside the function
...
window.requestAnimationFrame(function appendPizza() {
    for (var i = 2; i < 100; i++) pizzasDiv.appendChild(pizzaElementGenerator(i));
});
...
function updatePositions() {
    ...
    //calculate scrollPos outside the loop
